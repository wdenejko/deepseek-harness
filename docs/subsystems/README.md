...
| [local-models.md](local-models.md) | the opt-in remote local-model lifecycle owner: `LocalModelCatalog`/`LocalModelEntry`/`LocalModelRoute`, run-state, the endpoint probe, and `ctx.localModels` start/stop |
