...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/local-models/local-models': { kind: 'none', reason: 'Operator-facing lifecycle seam over SSH; registers no model-facing tool and enters no model request.' },
